[project2-28fb] Operating Details
====================================

Generated On: 2024-11-15 17:45:21 UTC
...
.. important::
   ...
   **not be valid if your [project2-28fb] container is NOT running**.

.. tip::
   You must have your [project2-28fb] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/carterd132/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46027  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='carterd132'  \-\-env DOCKERUSERNAME='carterd132@gmail.com'  \-\-env MQTTUSERNAME='yedgy'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   carterd132@gmail.com/project2-28fb-amd64 (https://hub.docker.com/r/carterd132@gmail.com/project2-28fb-amd64)
...
.. important::
   docker run -d -p 38973:38973 -p 50875:50875 -p 38701:38701 \-\-env TSS=0 \-\-env SOLUTIONNAME=project2-28fb \-\-env SOLUTIONDAG=solution_preprocessing_dag-project2-28fb \-\-env GITUSERNAME=carterd132  \-\-env GITREPOURL=https://github.com/carterd132/raspberrypi \-\-env SOLUTIONEXTERNALPORT=38973  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=50875  \-\-env SOLUTIONVIPERVIZPORT=38701 \-\-env DOCKERUSERNAME='carterd132@gmail.com'  \-\-env EXTERNALPORT=46027 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='yedgy' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  carterd132@gmail.com/project2-28fb-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - carterd132@gmail.com/project2-28fb-amd64
...
[project2-28fb] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/carterd132/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/project2-28fb
...
.. important::
   https://project2-28fb.readthedocs.io
...
.. important::
   solution_preprocessing_dag-project2-28fb
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=38973, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37959, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33761, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39605, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41717, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=39169, HPDEHOST=127.0.1.1, HPDEPORT=39747, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46837

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8686-project2-28fb,solution_preprocessing_dag-project2-28fb, python-preprocess-5836-project2-28fb,solution_preprocessing_dag-project2-28fb, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
